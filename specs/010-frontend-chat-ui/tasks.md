...
- [x] T010-002 Add basic styling/layout (panel or card) that works inside a docs page.
- [x] T010-003 Expose a simple prop API:
...
- [x] T010-012 Verify `npm test` and `npm run build` succeed after integration.
