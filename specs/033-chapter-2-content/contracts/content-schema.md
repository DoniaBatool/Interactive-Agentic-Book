# Content Schema: Chapter 2 Written Content (Mechanical Systems)
...
title: string              # Pattern: "Chapter N — Title"
                          # Example: "Chapter 2 — The Foundations of Mechanical Systems"
...
sidebar_label: string      # Abbreviated title for sidebar
                          # Example: "Chapter 2: Mechanical Systems"
                          # Constraints: 10-50 characters

# Optional fields
tags: string[]            # Categorization tags
                          # Example: ["mechanical-systems", "forces", "energy", "simple-machines", "beginner"]
...
CHAPTER_METADATA = {
    ...
    "learning_outcomes": List[str],  # Measurable learning objectives (5-7 items)
...
- **Example**: `"A foundational chapter covering forces, motion, energy, work, and simple machines. Explores how mechanical systems work, why mechanical advantage matters, and how robots use mechanical systems. Suitable for beginners who have completed Chapter 1."`
...
- **Example**: `["force-motion", "energy-work", "simple-machines", "robotics-mechanics"]`
...
- **Type**: `List[str]`
- **Constraints**: 5-7 items, each must start with action verb (Define, Identify, Explain, etc.), suitable for quiz generation
- **Purpose**: Used for RAG embedding, quiz generation, progress tracking
- **Example**:
  ```python
  [
      "Define force and motion and explain Newton's laws at a beginner level",
      "Explain energy, work, and mechanical efficiency with real-world examples",
      "Identify different types of simple machines and their applications",
      "Describe how robots use mechanical systems and force transmission",
      "Understand safety considerations in mechanical systems"
  ]
  ```
...
- **Example**: `["Force", "Motion", "Work", "Energy", "Mechanical Advantage", "Simple Machine", "Efficiency"]`
...
**Invalid Examples**:
```markdown
Force: No bold formatting ❌
**Force** : Space before colon ❌
**Force** Definition with no colon ❌
**Force** Push (too short, < 10 words) ❌
**Force** Force is a force (circular definition) ❌
```
