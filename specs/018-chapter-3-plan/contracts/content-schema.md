# Content Schema: Chapter 3 — Planning Layer

**Feature**: 018-chapter-3-plan
**Date**: 2025-12-05
**Purpose**: Define data contracts and validation schemas for Chapter 3 planning layer structure
...
- `ai_blocks` count MUST match MDX AI-block placeholders (4)
...
- Placeholder types MUST match metadata `ai_blocks` list exactly
...
**Format**: Content within MDX sections
**Location**: `frontend/docs/chapters/chapter-3.mdx` within sections
...
**Validation Rules**:
- Content MUST be accessible to Grade 7-8 reading level
...
- Function MUST respect chunk markers (CHUNK: START / CHUNK: END)

---

## Chunking Strategy Schema

**Format**: Documentation in spec.md and research.md
**Location**: `specs/018-chapter-3-plan/spec.md` and `specs/018-chapter-3-plan/research.md`
...
**Validation Rules**:
- Chunking strategy MUST be clearly defined
- Chunk markers MUST align with concept boundaries
- Chunking strategy MUST respect H2 section boundaries
- RAG integration points MUST be documented
...
- MDX AI-block placeholders MUST match metadata `ai_blocks` list
...
- All CHUNK: START markers MUST have corresponding CHUNK: END markers
- Chunk markers MUST align with concept boundaries
- Chunk markers MUST respect H2 section boundaries
...
- [ ] AI-block placeholder schema defined (HTML comment format)
- [ ] Chunk marker schema defined
- [ ] Section structure schema defined
- [ ] Paragraph rules schema defined
- [ ] RAG chunk file schema defined
- [ ] Chunking strategy schema defined
